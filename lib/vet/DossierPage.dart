  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Icon(Icons.assignment, color: Colors.white), // Icone des dossiers
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text(
          'Propriétaire: ${pet.ownerName?.isNotEmpty == true ? pet.ownerName : 'Inconnu'}',
          style: const TextStyle(
            fontSize: 14,
            color: Colors.grey,
          ),
        ...
        trailing: IconButton(
          ...
          tooltip: 'Ajouter un Dossier Médical',
          onPressed: () => _addDossier(pet),
        ),
      ),
    );
  }

  void _addDossier(Pet pet) {
    Get.to(() => DossierFormPage(pet: pet)); 
  }
}
